...
def initialize_dvc() -> None:
    ...
    DATA_UTILS_LOGGER.info("Initializing DVC - commiting")
    run_shell_command("git commit -nm 'Initialized DVC - complete'")
    DATA_UTILS_LOGGER.info("Initializing DVC - logging done")
